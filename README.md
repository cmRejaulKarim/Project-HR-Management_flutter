...
| :--------------- | :---------------------------------------------- | :-------------------------------------------- |
| **Welcome/Home** | The initial landing screen for the application. | ![Home Screen](./UI/Home.png)                 |
| **Login**        | User authentication screen.                     | ![Login Screen](./UI/Login.png)               |
| **Registration** | New user sign-up screen.                        | ![Registration Screen](./UI/Registration.png) |
...
| :-------------------------- | :------------------------------------------ | :------------------------------------------------------ |
| **Admin Dashboard**         | Main overview for the System Administrator. | ![Admin Dashboard](./UI/AdminDash.png)                  |
| **Dept Head Dashboard**     | Main overview for a Department Head.        | ![Department Head Dashboard](./UI/DeptHeadDash.png)     |
| **Drawer Menu (Admin)**     | Navigation menu access for Admin.           | ![Admin Drawer Menu](./UI/AdminDrawer.png)              |
| **Drawer Menu (Dept Head)** | Navigation menu access for Department Head. | ![Department Head Drawer Menu](./UI/DeptHeadDrawer.png) |
